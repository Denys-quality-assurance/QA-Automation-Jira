...
import hillelauto.testrail_reporting.TestRail;
import hillelauto.testrail_reporting.TestrailVars;
...
public class TestListener implements ITestListener {
    ...
    private void reportToTestRail(HashSet<ITestResult> results) {
        ...
        try {
            trReport.startRun(Integer.parseInt(projectId), runPrefix + " Denys Auto - " + Tools.timestamp("forIssue"));
